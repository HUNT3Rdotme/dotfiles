...
complete -c borg-recreate -l keep-exclude-tags -d 'if tag objects are specified with --exclude-if-present, don\\(aqt omit the tag…'
...
complete -c borg-recreate -s C -l compression -d 'select compression algorithm, see the output of the \\(dqborg help compression…'
